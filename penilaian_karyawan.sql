...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Nov 2022 pada 15.14
...
CREATE TABLE `penilaian` (
  ...
  `timestimp` decimal(3,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Struktur dari tabel `perengkingan`
--

CREATE TABLE `perengkingan` (
...
--
-- Indeks untuk tabel `perengkingan`
--
ALTER TABLE `perengkingan`
...
--
-- AUTO_INCREMENT untuk tabel `perengkingan`
--
ALTER TABLE `perengkingan`
